...
\begin{figure}[H]
    \centering
    \includezxdiagram{chapter-3/pauli_gadget_fusion}{0.55}
...
\begin{figure}[H]
    \centering
    \includezxdiagram{chapter-3/pauli_gadget_commutation}{0.64}
...
\vspace{5pt}
\includezxdiagram{chapter-3/pauli_gadget_single_leg}{0.75}
