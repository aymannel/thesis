...
Similarly, the two-body excitation operator can be factorised into eight commuting exponential terms, and implemented by composing their corresponding Pauli gadgets, resulting in the following representation in the ZX calculus.
