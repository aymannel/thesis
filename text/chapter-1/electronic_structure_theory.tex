...
% \end{gather*}
% \caption{Antisymmetric linear combination of Hartree products $\Psi_{1,2}(\mathbf{x_1}, \mathbf{x_2})$.}
% \end{figure}

A general procedure for this is achieved by constructing a Slater determinant from the finite set of spin orbitals, where each row relates to the electron coordinate $\mathbf{x_n}$ and each column corresponds to a particular spin orbital $\phi_i$ \cite{Atilla1996}. 
...
With these creation and annhilation operators in mind, the Hamiltonian in second quantisation can be expressed as follows.
\begin{equation*}
    \hat H =
