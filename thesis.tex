...
\include{text/chapter-1/background}
\include{text/chapter-1/electronic_structure_theory}
\include{text/chapter-1/quantum_computation}
\include{text/chapter-1/fermion_encodings}
\include{text/chapter-1/unitary_coupled_cluster}

\include{text/chapter-2/generators}
\include{text/chapter-2/rewrite_rules}
\include{text/chapter-2/phase_gadgets}
\include{text/chapter-2/pauli_gadgets}
\include{text/chapter-2/zxfermion}

\include{text/chapter-3/vqe}
\include{text/chapter-3/disco_vqe}
\include{text/chapter-3/single_excitation}
\include{text/chapter-3/double_excitation}
\include{text/chapter-3/spin_adapted_excitation}
