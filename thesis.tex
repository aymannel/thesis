...
\include{text/background/background}
\include{text/background/electronic_structure_theory}
\include{text/background/quantum_computation}
\include{text/background/fermion_encodings}
\include{text/background/unitary_coupled_cluster}

\include{text/chapter-1/generators}
\include{text/chapter-1/rewrite_rules}
\include{text/chapter-1/phase_gadgets}
\include{text/chapter-1/pauli_gadgets}
\include{text/chapter-1/zxfermion}

\include{text/chapter-2/vqe}
\include{text/chapter-2/disco_vqe}
\include{text/chapter-2/single_excitation}
\include{text/chapter-2/double_excitation}
\include{text/chapter-2/spin_adapted_excitation}

\include{text/chapter-3/controlled_rotations}
