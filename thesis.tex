...
% Thank you Razin Shaikh, Boldizsár Poór, Richie Yeung and Harny Wang. \\
...
\include{text/chapter-1/unitary_coupled_cluster_ansatz}
...
\include{text/chapter-4/changing_basis}

% EXCITATION OPERATORS
\include{text/chapter-5/introduction}
\include{text/chapter-5/implementing_excitation_operators}
\include{text/chapter-5/excitation_operators_pauli_gadgets}
\include{text/chapter-5/operator_commutations}
\include{text/chapter-5/diagrammatic_diagonalisation}
\include{text/chapter-5/controlled_rotations}
\include{text/chapter-5/one_body_excitation_operators}
\include{text/chapter-5/two_body_excitation_operators}
