...
\include{text/chapter-4/cnot}
\include{text/chapter-4/cliffords}

% ZX FERMION SOFTWARE
% \include{text/chapter-5/introduction}
% \include{text/chapter-5/creating_gadgets}
% \include{text/chapter-5/creating_circuits}
% \include{text/chapter-5/commutation_relations}
